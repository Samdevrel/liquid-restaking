      ...
      <div className="max-w-4xl mx-auto p-8">
        ...
        <section className="bg-gray-900 border-4 border-purple-400 p-6 mb-8">
          ...
          <p className="text-gray-300 mb-4">
            Restake tokens and receive liquid derivatives that can be used elsewhere in DeFi while earning additional rewards.
          </p>
        ...
        <section className="bg-gray-900 border-4 border-gray-700 p-6 mb-8">
          ...
          <ol className="list-decimal list-inside space-y-3 text-gray-300">
            <li>Restake tokens into restaking protocol</li>
            <li>Receive liquid restaking derivatives</li>
            <li>Use derivatives in other DeFi applications</li>
          </ol>
        </section>
        ...
        <section className="bg-gray-900 border-4 border-gray-700 p-6 mb-8">
          ...
          <ul className="space-y-2 text-gray-300">
            <li>✓ Highest yield opportunities</li>
            <li>✓ Liquid derivative use</li>
            <li>✓ Real-time reward accrual</li>
            <li>✓ Risk exposure management</li>
            <li>✓ Automated restaking</li>
          </ul>
        </section>
        ...
        <section className="bg-gray-900 border-4 border-green-400 p-6 mb-8">
          ...
          <ol className="list-decimal list-inside space-y-2 text-gray-300">
            ...
            <li>Restake tokens</li>
            <li>Receive liquid derivatives</li>
          </ol>
        </section>
